                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                    ...
                                    <tr>
                                        ...
                                        <th>Status</th>
                                        <th>Day Count</th>
                                        <th style="padding-left:3px">Withdraw</th>
                                        <th>Date</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>       <div class="dropdown d-inline mr-2">
                                                    ...
                                                    <div class="dropdown-menu"style="background-color:white">
                                                        <a  class="dropdown-item" href="withdraw.php?user_id=<?php echo $userDetails['deposit_id'];?>">Withdraw Profit</a>
                                                        <a  class="dropdown-item" href="withdrawamount.php?user_id=<?php echo $userDetails['deposit_id'];?>">Withdraw Amount</a>
                                                        <a  class="dropdown-item" href="button_reinvest.php?user_id=<?php echo $userDetails['deposit_id']?>&action=upgrate">Re-invest</a>
                                                    </div>
                                                </div>
                                            </td>
