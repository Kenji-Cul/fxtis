        ...
        <div class="col-xs-12 col-xs-offset-0 col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-3">
            ...
            <div class="text-center" style="margin-top: 10px">
                <form action="../action/main_work.php?option=<?php echo $action ;?>" method="post">
                    ...
                    <button type="submit" class="btn-info-<?php if($action === 'del'){ print 'danger'; } else{ echo 'success'; } ?> btn-lg">Yes</button>
                    <a href="all_withdrawamount.php" class="btn btn-success btn-lg">No</a>
                </form>
