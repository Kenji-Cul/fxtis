                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                            ...
                                            <td>     <div class="dropdown d-inline mr-2">
                                                    ...
                                                    <a class="dropdown-item" href="de_profiledeposit.php?user_id=<?php echo $allusers->users_unique_id ?>&action=edit">Edit</a>
                                                        <a class="dropdown-item" href="promptinter.php?user_id=<?php echo $allusers->users_unique_id?>&action=deleteled">Delete</a>
