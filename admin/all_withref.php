...
<?php $alluser = $for->allwithdrawbonus()?>
                                        ...
                                        <?php foreach ($alluser as $k=> $allusers) { ;?>
                                            ...
                                            <td>           <div class="btn-group mb-2">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="prompt.php?user_id=<?php echo $allusers->withbouns_id ?>&action=delete4">Delate</a>
                                                        <a class="dropdown-item" href="prompt.php?user_id=<?php echo $allusers->withbouns_id ?>&action=<?php echo $allusers->status === 'confirmed' ? 'pendiiing':'confiiirmed'; ?>"><?php echo $allusers->status === 'confirmed' ? 'pending':'confirmed'; ?></a>
                                                    </div>
                                                </div>
                                            </td>
                                            <?php $no++; } ?>
