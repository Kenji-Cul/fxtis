                                        ...
                                        <?php foreach ($alluser as $k=> $allusers) { ;?>
                                            ...
                                            <td>       <div class="dropdown d-inline mr-2">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="prompts.php?user_id=<?php echo $allusers->deposit_id ?>&action=delete">Delate</a>
                                                        <a class="dropdown-item" href="prompts.php?user_id=<?php echo $allusers->deposit_id ?>&action=<?php echo $allusers->status === 'confirmed' ? 'block':'unblock'; ?>"><?php echo $allusers->status === 'confirmed' ? 'pending':'confirmed'; ?></a>
                                                    </div>
                                                </div>
                                            </td>
                                            <?php $no++; } ?>
